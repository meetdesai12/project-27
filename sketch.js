...
function setup() {
	...
	bobObject4 = new bob(450,575,40);
	bobObject5 = new bob(500,575,40);
	...
	rope4=new rope(bobObject4.body,roofObject.body,35,0);
...
function draw() {
 ...
 function drawline(constraint) {
	 ...
	 roofBodyX= roofBody.Position.x + roofBodyOffset.x;
	 roofBodyY= roofBody.Position.y + roofBodyOffset.y;
